...
<br>
:page_with_curl: **Pure CSS**
<br>
A custom CSS system like BEM will require a varying amount of time to learn and reproduce when onboarding a new developer. The purpose of writing semantic CSS is to write classes that are easy to read and that showcase element hierarchy. The intention of this is to help one understand where a module begins or ends. In shorter words, the Semantic approach trys to sell you on readability!
